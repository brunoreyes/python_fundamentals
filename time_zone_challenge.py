...
available_zones = {'1': "Africa/Tunos",
                    '2': "Asia/Kolkata",
                    '3': "Australia/Adelaide",
                    '4': "Europe/Brussels",
                    '5': "Europe/London",
                    '6': "Japan",
                    '7': "Pacific/Tahiti/Tunos",
                    '8': "US/Hawaii",
                    '9': "Zulu"}
...
while True:
    ...
    if choice == '0': # The user has chosen 0 to quit
        break
    ...
    if choice in available_zones.keys():
        ...
        print("Local time is {}".format(datetime.datetime.now().strftime('%A %x %X'))) #%A: day, %x: date, %X: time
