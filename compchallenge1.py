...
fizzbuzz = ["fizz buzz" if number % 15 == 0 else "fizz" if number % 3 == 0 else "buzz" if number % 5 == 0 else str(number) for number in range(1,31)]

for number in fizzbuzz:
    print(number.center(12, '*')) # print a number on each line with 6 * on both sides of #: ******fizz******
