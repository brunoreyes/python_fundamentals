# import colorama
# on windows and lunux operating systems you have to do the above to
# enable ANSI esqape sequences.

# It is important to check that, if you are going to use external packages, make sure 
# it is being maintained, it not it could contain bugs w/o documentation anywhere
